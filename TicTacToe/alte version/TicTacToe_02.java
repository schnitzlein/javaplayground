...
/**
  ...
  * Beschreibung
  *
  * @version 1.2 vom 01.04.2008
  * @author Chris
  */

public class TicTacToe_02 extends Frame
implements ActionListener,MouseListener{
  ...
  public TicTacToe_02(String title) {
         ...
         && l22.getLabel()=="X" && l32.getLabel()=="X")|| (l13.getLabel()=="X" && l23.getLabel()=="X"
          && l33.getLabel()=="X")|| (l11.getLabel()=="X" && l22.getLabel()=="X" && l33.getLabel()=="X")||(l13.getLabel()=="X"
           && l22.getLabel()=="X" && l31.getLabel()=="X"))
              ...
              break;
      case 2:
              if (l11.getLabel()=="O" && l12.getLabel()=="O" && l13.getLabel()=="O")status=true;  //waagerecht
  ...
  public static void main(String[] args) {
    TicTacToe_02 game = new TicTacToe_02("TicTacToe_02");
