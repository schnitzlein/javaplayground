...
import java.math.*;
//TODO überflüssige Pakete entfernen, generell ohne label, label bei memory
  ...
  public void itemStateChanged(ItemEvent e) {
    if (e.getStateChange() == ItemEvent.SELECTED) {
      ...
      if (e.getItem().equals(s2Button)) {
        sp = 2;
        this.KiDings(); anzeige.setLabel("X ist dran");
      }
    ...
    switch(sp){
      ...
      case 2:
       ...
       // nach gesetzter Markierung wird gewechselt
          ...
          schreibePos(Integer.parseInt(s));*/
...
//        KiZufall();
  ...
  //liest Feld an posi aus und lädt den kompletten Feldspeicher in die db
...
//          System.out.print(compWin()+" ");
  ...
  //wartet blockierend auf eine nachricht, gibt sie als String zurück
  ...
  //sendet blockierend eine Nachricht via udp, wartet auf bestätigung
